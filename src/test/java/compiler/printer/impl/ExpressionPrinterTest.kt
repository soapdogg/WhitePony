...
class ExpressionPrinterTest {
    ...
    companion object {
        ...
        fun inputData(): Stream<Pair<IParsedExpressionNode, String>> {
            ...
            val parsedUnaryOperator = Mockito.mock(ParsedUnaryExpressionNode::class.java)
            ...
            val parsedUnaryPreOperator = Mockito.mock(ParsedUnaryPreOperatorExpressionNode::class.java)
            ...
            val parsedUnaryPostOperator = Mockito.mock(ParsedUnaryPostOperatorExpressionNode::class.java)
            ...
            val parsedBinaryAssign = Mockito.mock(ParsedBinaryAssignExpressionNode::class.java)
            ...
            val parsedBinaryAssignOperator = Mockito.mock(ParsedBinaryAssignOperatorExpressionNode::class.java)
            ...
            val parsedBinaryAndOperator = Mockito.mock(ParsedBinaryAndOperatorExpressionNode::class.java)
            ...
            val parsedBinaryOrOperator = Mockito.mock(ParsedBinaryOrOperatorExpressionNode::class.java)
            ...
            val parsedBinaryOperator = Mockito.mock(ParsedBinaryOperatorExpressionNode::class.java)
            ...
            val parsedBinaryArrayOperator = Mockito.mock(ParsedBinaryArrayExpressionNode::class.java)
